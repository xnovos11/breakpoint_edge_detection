%% DEMO - Condat algorithm - orthonormal ans random orthonormal basis
...
param_method.epsilon_ball=norm(y-signal_clean);
...
legend('clean','observed', 'nonCA_{hh}');
...
legend( 'Objective function nonCA_{hh}')
