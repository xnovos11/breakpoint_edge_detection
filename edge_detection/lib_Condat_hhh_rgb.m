function [batch,batch_cnt]=lib_Condat_hhh_rgb(param_method, param_solver, signal_characteristics, batch, batch_cnt)
...
param.verbose = 3;
param.y = signal_characteristics.signal_clean(:,:,batch_cnt);
